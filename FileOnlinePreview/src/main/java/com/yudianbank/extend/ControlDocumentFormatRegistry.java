...
import com.artofsolving.jodconverter.document.DocumentFamily;
import com.artofsolving.jodconverter.document.DocumentFormat;
import com.artofsolving.jodconverter.document.SimpleDocumentFormatRegistry;

import com.sun.star.beans.PropertyValue;

/**
 * 重写了DefaultDocumentFormatRegistry类，因为要添加自定义行为，比如字符编码。。。 </br>
 * 实现转换配置
 * @author yudian-it
 * @date 2017/12/5
 */
