...
//
package com.artofsolving.jodconverter.office;

import java.io.File;
import java.util.Arrays;

import com.artofsolving.jodconverter.process.ProcessManager;
import com.artofsolving.jodconverter.process.PureJavaProcessManager;
import com.artofsolving.jodconverter.process.LinuxProcessManager;
import com.artofsolving.jodconverter.process.SigarProcessManager;
import com.artofsolving.jodconverter.util.PlatformUtils;
...
public class DefaultOfficeManagerConfiguration {
    ...
    /**
     * 参考案例是 返回FALSE ,手动设置false
     * @return
     * @author HYL   
     * @date 2018年1月4日 上午10:24:23
     */
...
//        }
	...
	public String toString() {
		return "DefaultOfficeManagerConfiguration [officeHome=" + officeHome + ", connectionProtocol="
				+ connectionProtocol + ", portNumbers=" + Arrays.toString(portNumbers) + ", pipeNames="
				+ Arrays.toString(pipeNames) + ", runAsArgs=" + Arrays.toString(runAsArgs) + ", templateProfileDir="
				+ templateProfileDir + ", workDir=" + workDir + ", taskQueueTimeout=" + taskQueueTimeout
				+ ", taskExecutionTimeout=" + taskExecutionTimeout + ", maxTasksPerProcess=" + maxTasksPerProcess
				+ ", retryTimeout=" + retryTimeout + ", processManager=" + processManager + "]";
	}
